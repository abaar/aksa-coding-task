	...
	<div class="container-fluid" style="margin-top:1%">
		<div class="row">
			<div class="col-md-4 col-md-offset-4">
				<form method="POST" action="{{route('tugas1.show.post')}}">
				...
				<button style="margin-top: 5px; background-color: green;" class="btn btn-primary col-md-12" onclick=redirect('{{route('tugas1.home')}}')>Back</button>	
			</div>
		</div>		
	</div>
