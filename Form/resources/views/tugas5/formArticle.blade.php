	...
	<div class="container-fluid" style="margin-top:1%">
		<div class="row">
			<div class="col-md-4 col-md-offset-4">
				...
				<form method="get" action="{{ Route('tugas5.input.form') }}">
				...
				<button class="btn btn-primary col-md-12" style="margin-top:1%" onclick="redirect('{{ Route('tugas5.show.article') }}')">Article</button>		
				<button class="btn btn-primary col-md-12" style="margin-top:1%" onclick="redirect('{{ Route('tugas5.show.category') }}')">Category</button>	
			</div>
		</div>		
	</div>
